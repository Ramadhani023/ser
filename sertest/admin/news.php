    ...
    <div class="mt-5">
        <?php if ($loggedin): ?>
            <div class="container text-center">
                <a href="crud/addb.php" class="btn btn-outline-primary my-5">
                    <h3><strong>Tambah Berita</strong></h3>
                </a>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['tanggal'];?></td>
                                <td>
                                    <a href="crud/editb.php?id=<?= $row['id_news'];?>" class="btn btn-outline-warning">Edit</a>
                                    <a href="../process/delb.php?id=<?= $row['id_news'];?>" class="btn btn-outline-danger" onclick="return confirm('Yakin Ingin Menghapus Data?')">Delete</a>
                                </td>
                            </tr>
                        <?php } ?>
                    </tbody>

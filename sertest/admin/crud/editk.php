...
$query = mysqli_query($conn, "SELECT * FROM act WHERE id_act='$id'");
    ...
    <div class="mt-5">
        <?php if ($loggedin): ?>
            <div class="container shadow-lg rounded-4">
                <form action="../../process/editk.php" method="post" enctype="multipart/form-data" class="form my-5 py-5 px-5">
                        <input type="hidden" name="id" id="" value="<?= $row['id_act'];?>">
                    <div>
